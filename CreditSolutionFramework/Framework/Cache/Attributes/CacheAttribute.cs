   ...
   public class CacheAttribute : Attribute, ICacheAttribute
    {
        ...
        public async Task<string> OnBeforeAsync(MethodInfo targetMethod, object[] args, ICustomDistributedCache distributedCache)
        {
            Key = SetKey(Key, targetMethod, args);
            return await distributedCache.GetStringAsync(Key);
        }

        public string OnBefore(MethodInfo targetMethod, object[] args, ICustomDistributedCache distributedCache)
        {
            Key = SetKey(Key, targetMethod, args);
        ...
        public async Task OnAfterAsync(MethodInfo targetMethod, object[] args, object value,
            ICustomDistributedCache distributedCache)
        {
            await distributedCache.SetAsync(Key, TTL, value);
        }

        public void OnAfter(MethodInfo targetMethod, object[] args, object value, ICustomDistributedCache distributedCache)
        {
