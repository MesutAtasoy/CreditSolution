...
namespace Framework.EventBusRabbitMQ
{
   public abstract class RabbitMqClientBase : IDisposable
       {
           protected const string VirtualHost = "CUSTOM_HOST";
           protected readonly string LoggerExchange = $"{VirtualHost}.CreditExchange";
           protected readonly string LoggerQueue = $"{VirtualHost}.credit.message";
           protected const string LoggerQueueAndExchangeRoutingKey = "credit.message";
